...
import type { SignOffStatusTone } from "../../lib/shiftReportListData";
import styles from "./StatusTag.module.css";

export type StatusTagProps = {
  tone: SignOffStatusTone;
  label: string;
  theme?: "light" | "dark";
...
const TONE_ICON: Record<SignOffStatusTone, ReactNode> = {
...
/** StatusTag — a day's sign-off status (getSignOffStatusDisplay) as a tinted, icon-led tag. Shared by the Shift Reports list's Status column and its calendar view so both read identically. */
